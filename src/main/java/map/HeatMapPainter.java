...
public class HeatMapPainter implements Painter<JXMapViewer> {
    ...
    public void paint(Graphics2D g, JXMapViewer map, int w, int h) {
        ...
        BufferedImage out = constructImage(w, h, maxIntensity, intensity);
        g.drawImage(out, 0, 0, null);
    }

    public static BufferedImage constructImage(int w, int h, float maxIntensity, float[][] intensity) {
    ...
    private static Color getColorFromGradient(float value) {
